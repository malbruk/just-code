 ...
 * simply forgets it. Also owns the `green-code.hasPendingEdits` context key
...
export class PendingEditManager implements vscode.Disposable {
  static readonly SCHEME = 'green-code-diff';
  ...
  private updateContextKey(): void {
    void vscode.commands.executeCommand('setContext', 'green-code.hasPendingEdits', this.pending.size > 0);
  }
